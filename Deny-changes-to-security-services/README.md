...
|[Use AWS IAM Identity Center for AWS Managed Applications or Trusted Identity Propagation Only](Deny-permission-sets-for-AWS-IAM-Identity-Center.json)| Does not allow the creation or modification of permission sets or SAML providers for an Identity Center delegated admin account, helping ensure Identity Center is only used for Applications and Trusted Identity Propagation|
